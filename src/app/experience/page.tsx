              ...
              {item.impactHighlights.map((highlight) => (
                <li key={highlight} className="flex gap-2">
                  {isActive ? (
                    ...
                    <span className="mt-1.5 w-1.5 h-1.5 bg-muted-foreground/70 rounded-full shrink-0 brightness-105"></span>
                  )}
                  <span>{highlight}</span>
                </li>
              ))}
              ...
              >
                ...
                <span className="ml-2 mb-1.5 inline-flex h-2.5 w-2.5 items-center justify-center">
                  {isActive ? (
                    ...
                    <span className="w-1.5 h-1.5 bg-muted-foreground/70 rounded-full shrink-0 brightness-105"></span>
                  )}
                </span>
              </button>
            </li>
    ...
    >
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        ...
        <div className="surface-soft space-y-1 rounded-2xl border border-border/70 p-3.5">
          ...
          <p className="text-xs text-muted-foreground">
            A mix of engineering, product discovery, and
