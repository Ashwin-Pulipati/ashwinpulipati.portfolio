...
type CursorProviderProps = React.HTMLAttributes<HTMLDivElement> & {
...
const DefaultCursorIcon: React.FC = () => (
  <svg
...
const Cursor = React.forwardRef<HTMLDivElement, CursorProps>(
  ({ children, className, style, ...props }, forwardedRef) => {
    ...
    React.useEffect(() => {
      ...
      const previousCursor = parentElement.style.cursor;

      if (isActive) {
        parentElement.style.cursor = "none";
      } else {
        parentElement.style.cursor = previousCursor || "";
      }
...
const CursorFollow = React.forwardRef<HTMLDivElement, CursorFollowProps>(
  (
    ...
    const cursorFollowRef = React.useRef<HTMLDivElement | null>(null);
